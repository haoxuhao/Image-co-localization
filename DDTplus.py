...
class DDTplus(object):
    def __init__(self, selected_layers=(34, 36)):
            ...
            for i, layer in enumerate(self.pretrained_feature_model):
                ...
                if i in self.selected_layers:
                    ...
                    if i == self.selected_layers[0]:
                        descriptors0 = np.vstack((descriptors0, output.detach().numpy().copy()))
                    else:
                        descriptors1 = np.vstack((descriptors1, output.detach().numpy().copy()))
                    del output
...
if __name__=="__main__":
    ...
    ddt_plus = DDTplus(args.select_layers)
